 ...
 * @author yitian_song
 */
public class FollowByMetric_Multithread_3 {
            ...
            executorService.submit(() -> {
                ...
                try {
                    ...
                    while (--remainingEvents > 0) {
                        ...
                        int index = (int) cnt % numTaskPerCore + numTaskPerCore * engineIndex;
                        ...
                        epService.getEPRuntime().sendEvent(element, "TestEvent");
                    }
                    cdt.countDown();
                } catch (Exception e) {
