 ...
 * @author yitian_song
 */
public class WindowStateMetric {
    private static final Logger logger = LoggerFactory.getLogger(WindowStateMetric.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String epl = FileUtil.readResourceAsString("epl_case23_window_count.sql");
