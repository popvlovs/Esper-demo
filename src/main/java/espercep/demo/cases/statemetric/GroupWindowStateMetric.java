 ...
 * @author yitian_song
 */
public class GroupWindowStateMetric {
    private static final Logger logger = LoggerFactory.getLogger(GroupWindowStateMetric.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String epl = FileUtil.readResourceAsString("epl_case21_window_count.sql");
