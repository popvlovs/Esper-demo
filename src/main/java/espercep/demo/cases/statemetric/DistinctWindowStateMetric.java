 ...
 * @author yitian_song
 */
public class DistinctWindowStateMetric {
    private static final Logger logger = LoggerFactory.getLogger(DistinctWindowStateMetric.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String epl = FileUtil.readResourceAsString("epl_case22_window_count.sql");
